...
-- CreateEnum
CREATE TYPE "public"."ClassificacaoTriagem" AS ENUM ('VERDE', 'AMARELO', 'VERMELHO', 'AZUL');
...
-- AddForeignKey
ALTER TABLE "public"."patient_events" ADD CONSTRAINT "patient_events_upa_id_fkey" FOREIGN KEY ("upa_id") REFERENCES "public"."upas"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
